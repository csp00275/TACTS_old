...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "a703e4ba8fc63217c20497986017b55f"
...
#define AI_TOOLS_DATE_TIME   "Wed Aug 30 15:27:13 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    128, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_IN_NUM, &serving_default_dense_16_input0_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_sine_model_activations_map, 1, params)) {
    ...
    serving_default_dense_16_input0_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 60);
    serving_default_dense_16_input0_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 60);
    ...
    dense_3_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 0);
    dense_3_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 0);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_sine_model_weights_map, 1, params)) {
    ...
    dense_0_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 0);
    dense_0_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 0);
    
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 64);
    dense_1_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 64);
    
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 1088);
    dense_1_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 1088);
    
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 1152);
    dense_2_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 1152);
    
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 2176);
    dense_2_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 2176);
    
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 2240);
    dense_3_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 2240);
    
    dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 2304);
    dense_3_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 2304);
    
    dense_0_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_0_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 2308);
    dense_0_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 2308);
