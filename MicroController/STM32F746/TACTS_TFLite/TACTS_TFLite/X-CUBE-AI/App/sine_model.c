...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "65e4e2af089d16a5d21e8e82dbd7c980"
...
#define AI_TOOLS_DATE_TIME   "Wed Aug 30 13:58:53 2023"
...
AI_STATIC ai_array nl_1_output_array;   /* Array #12 */
AI_STATIC ai_array dense_2_output_array;   /* Array #13 */
AI_STATIC ai_array nl_2_output_array;   /* Array #14 */
...
AI_STATIC ai_tensor nl_1_output;   /* Tensor #12 */
AI_STATIC ai_tensor dense_2_output;   /* Tensor #13 */
AI_STATIC ai_tensor nl_2_output;   /* Tensor #14 */
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    serving_default_dense_16_input0_output_array.data = AI_PTR(NULL);
    serving_default_dense_16_input0_output_array.data_start = AI_PTR(NULL);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_3_bias_array.data = AI_PTR(weights + 2368);
    dense_3_bias_array.data_start = AI_PTR(weights + 2368);
