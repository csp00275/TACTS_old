...
#define AI_TOOLS_DATE_TIME   "Wed Aug 30 16:59:43 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_OUT_NUM, &gemm_3_output),
  &gemm_0_layer, 0, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_sine_model_weights_map, 1, params)) {
    ...
    gemm_3_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 2368);
    gemm_3_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 2368);
