...
#define AI_NETWORK_MODEL_SIGNATURE     "055dc8c108e6584719d433c80c97d4d1"
...
#define AI_TOOLS_DATE_TIME   "Fri Oct 20 08:54:15 2023"
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_5_output_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.008496640250086784f),
    AI_PACK_INTQ_ZP(9)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conversion_0_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0038968182634562254f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_1_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.02212994173169136f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_2_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.10780772566795349f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_3_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.039139460772275925f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_4_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.018109094351530075f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    1664, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_dense_5_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &conversion_6_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_dense_5_input0_output_array.data = AI_PTR(g_network_activations_map[0] + 916);
    serving_default_dense_5_input0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 916);
    
    conversion_0_output_array.data = AI_PTR(g_network_activations_map[0] + 916);
    conversion_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 916);
    
    gemm_1_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 952);
    gemm_1_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 952);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 18432);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 18432);
    
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 20480);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 20480);
    
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 86016);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 86016);
    
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 86528);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 86528);
    
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 94720);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 94720);
    
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 94976);
    gemm_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 94976);
    
    gemm_4_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 99072);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 99072);
    
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 99328);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 99328);
    
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 99584);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 99584);
