...
#ifndef __AI_SINE_MODEL2_H__
#define __AI_SINE_MODEL2_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_SINE_MODEL2_MODEL_NAME          "sine_model2"

#define AI_SINE_MODEL2_IN_NUM       (1)
#define AI_SINE_MODEL2_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_MODEL2_IN_SIZE { \
  (1 * 1 * 1), \
}
#define AI_SINE_MODEL2_IN_1_SIZE  (1 * 1 * 1)
#define AI_SINE_MODEL2_IN_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_SINE_MODEL2_INPUTS_IN_ACTIVATIONS


#define AI_SINE_MODEL2_OUT_NUM      (1)
#define AI_SINE_MODEL2_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_MODEL2_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_SINE_MODEL2_OUT_1_SIZE  (1 * 1 * 1)
#define AI_SINE_MODEL2_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_SINE_MODEL2_N_NODES (6)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup sine_model2
 ...
 * @ref ai_sine_model2_create. Both the activations memory buffer 
 ...
 * using @ref ai_sine_model2_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_SINE_MODEL2_*
 * defines into file @ref sine_model2.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sine_model2_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_SINE_MODEL2_H__*/
