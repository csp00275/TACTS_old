...
#define AI_FOURLINE_ORIGIN_MODEL_NAME   "node_231014_1836_2kpa_4line_data_b9_quant_float32_float32_random_1"
...
#define AI_FOURLINE_IN_1_CHANNEL     (48)
#define AI_FOURLINE_IN_1_SIZE        (48)
#define AI_FOURLINE_IN_1_SIZE_BYTES  (192)
