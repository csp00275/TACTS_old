...
#ifndef AI_THREELINECV_H
#define AI_THREELINECV_H
#pragma once

#include "threelinecv_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_THREELINECV_MODEL_NAME          "threelinecv"
#define AI_THREELINECV_ORIGIN_MODEL_NAME   "node_3linedata_b9_2kpa_9v_"

/******************************************************************************/
#define AI_THREELINECV_ACTIVATIONS_ALIGNMENT   (4)
#define AI_THREELINECV_INPUTS_IN_ACTIVATIONS   (4)
#define AI_THREELINECV_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_THREELINECV_IN_NUM        (1)

AI_DEPRECATED
#define AI_THREELINECV_IN \
  ai_threelinecv_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_THREELINECV_IN_SIZE { \
  AI_THREELINECV_IN_1_SIZE, \
}
#define AI_THREELINECV_IN_SIZE_BYTES { \
  AI_THREELINECV_IN_1_SIZE_BYTES, \
}
#define AI_THREELINECV_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_THREELINECV_IN_1_CHANNEL     (36)
#define AI_THREELINECV_IN_1_SIZE        (36)
#define AI_THREELINECV_IN_1_SIZE_BYTES  (144)

/******************************************************************************/
#define AI_THREELINECV_OUT_NUM       (1)

AI_DEPRECATED
#define AI_THREELINECV_OUT \
  ai_threelinecv_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_THREELINECV_OUT_SIZE { \
  AI_THREELINECV_OUT_1_SIZE, \
}
#define AI_THREELINECV_OUT_SIZE_BYTES { \
  AI_THREELINECV_OUT_1_SIZE_BYTES, \
}
#define AI_THREELINECV_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_THREELINECV_OUT_1_CHANNEL     (4)
#define AI_THREELINECV_OUT_1_SIZE        (4)
#define AI_THREELINECV_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_THREELINECV_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup threelinecv
 ...
 * @ref ai_threelinecv_create. Both the activations memory buffer 
 ...
 * using @ref ai_threelinecv_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_threelinecv_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_threelinecv_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_THREELINECV_*
 * defines into file @ref threelinecv.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_threelinecv_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_THREELINECV_H */
