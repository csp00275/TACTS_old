...
#define AI_THREELINE_ORIGIN_MODEL_NAME   "node_231007_1358_2kpa_3line_data_b8_quant_float32_float32_random_1"
...
#define AI_THREELINE_IN_1_CHANNEL     (36)
#define AI_THREELINE_IN_1_SIZE        (36)
#define AI_THREELINE_IN_1_SIZE_BYTES  (144)
