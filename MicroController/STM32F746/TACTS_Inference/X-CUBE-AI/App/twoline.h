...
#define AI_TWOLINE_ORIGIN_MODEL_NAME   "node_231008_0119_2kpa_2line_data_b8_quant_float32_float32_random_1"

/******************************************************************************/
#define AI_TWOLINE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TWOLINE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TWOLINE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TWOLINE_IN_NUM        (1)

AI_DEPRECATED
#define AI_TWOLINE_IN \
  ai_twoline_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TWOLINE_IN_SIZE { \
  AI_TWOLINE_IN_1_SIZE, \
}
#define AI_TWOLINE_IN_SIZE_BYTES { \
  AI_TWOLINE_IN_1_SIZE_BYTES, \
}
#define AI_TWOLINE_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_TWOLINE_IN_1_CHANNEL     (24)
#define AI_TWOLINE_IN_1_SIZE        (24)
#define AI_TWOLINE_IN_1_SIZE_BYTES  (96)

/******************************************************************************/
#define AI_TWOLINE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TWOLINE_OUT \
  ai_twoline_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TWOLINE_OUT_SIZE { \
  AI_TWOLINE_OUT_1_SIZE, \
}
#define AI_TWOLINE_OUT_SIZE_BYTES { \
  AI_TWOLINE_OUT_1_SIZE_BYTES, \
}
#define AI_TWOLINE_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_TWOLINE_OUT_1_CHANNEL     (4)
#define AI_TWOLINE_OUT_1_SIZE        (4)
 ...
 * @ref ai_twoline_create. Both the activations memory buffer 
 ...
 * using @ref ai_twoline_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_twoline_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_twoline_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TWOLINE_*
 * defines into file @ref twoline.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
