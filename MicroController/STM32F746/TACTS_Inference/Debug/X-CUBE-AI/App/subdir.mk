...
X-CUBE-AI/App/%.o X-CUBE-AI/App/%.su: ../X-CUBE-AI/App/%.c X-CUBE-AI/App/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m7 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32F746xx -c -I../Core/Inc -I../Drivers/STM32F7xx_HAL_Driver/Inc -I../Drivers/STM32F7xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F7xx/Include -I../Drivers/CMSIS/Include -I../Drivers/VL53L0X/platform/inc -I../Drivers/VL53L0X/core/inc -I../Middlewares/ST/AI/Inc -I../X-CUBE-AI/App -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -o "$@"

clean: clean-X-2d-CUBE-2d-AI-2f-App

clean-X-2d-CUBE-2d-AI-2f-App:
	-$(RM) ./X-CUBE-AI/App/fourline.d ./X-CUBE-AI/App/fourline.o ./X-CUBE-AI/App/fourline.su ./X-CUBE-AI/App/fourline_data.d ./X-CUBE-AI/App/fourline_data.o ./X-CUBE-AI/App/fourline_data.su ./X-CUBE-AI/App/fourline_data_params.d ./X-CUBE-AI/App/fourline_data_params.o ./X-CUBE-AI/App/fourline_data_params.su ./X-CUBE-AI/App/threeline.d ./X-CUBE-AI/App/threeline.o ./X-CUBE-AI/App/threeline.su ./X-CUBE-AI/App/threeline_data.d ./X-CUBE-AI/App/threeline_data.o ./X-CUBE-AI/App/threeline_data.su ./X-CUBE-AI/App/threeline_data_params.d ./X-CUBE-AI/App/threeline_data_params.o ./X-CUBE-AI/App/threeline_data_params.su ./X-CUBE-AI/App/twoline.d ./X-CUBE-AI/App/twoline.o ./X-CUBE-AI/App/twoline.su ./X-CUBE-AI/App/twoline_data.d ./X-CUBE-AI/App/twoline_data.o ./X-CUBE-AI/App/twoline_data.su ./X-CUBE-AI/App/twoline_data_params.d ./X-CUBE-AI/App/twoline_data_params.o ./X-CUBE-AI/App/twoline_data_params.su
