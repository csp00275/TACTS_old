...
#include "line3_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_LINE3_MODEL_NAME          "line3"
#define AI_LINE3_ORIGIN_MODEL_NAME   "node_231007_1358_2kpa_160_data_b8_quant_float32_float32_random_2"

/******************************************************************************/
#define AI_LINE3_ACTIVATIONS_ALIGNMENT   (4)
#define AI_LINE3_INPUTS_IN_ACTIVATIONS   (4)
#define AI_LINE3_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_LINE3_IN_NUM        (1)

AI_DEPRECATED
#define AI_LINE3_IN \
  ai_line3_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_LINE3_IN_SIZE { \
  AI_LINE3_IN_1_SIZE, \
}
#define AI_LINE3_IN_SIZE_BYTES { \
  AI_LINE3_IN_1_SIZE_BYTES, \
}
#define AI_LINE3_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_LINE3_IN_1_CHANNEL     (36)
#define AI_LINE3_IN_1_SIZE        (36)
#define AI_LINE3_IN_1_SIZE_BYTES  (144)

/******************************************************************************/
#define AI_LINE3_OUT_NUM       (1)

AI_DEPRECATED
#define AI_LINE3_OUT \
  ai_line3_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_LINE3_OUT_SIZE { \
  AI_LINE3_OUT_1_SIZE, \
}
#define AI_LINE3_OUT_SIZE_BYTES { \
  AI_LINE3_OUT_1_SIZE_BYTES, \
}
#define AI_LINE3_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_LINE3_OUT_1_CHANNEL     (4)
#define AI_LINE3_OUT_1_SIZE        (4)
#define AI_LINE3_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_LINE3_N_NODES (7)
 ...
 * @ref ai_line3_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_line3_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_LINE3_*
 * defines into file @ref line3.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
