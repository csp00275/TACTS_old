...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "node_231008_0119_2kpa_2line_data_b8_quant_float32_float32_random_1"
...
#define AI_NETWORK_IN_1_CHANNEL     (24)
#define AI_NETWORK_IN_1_SIZE        (24)
#define AI_NETWORK_IN_1_SIZE_BYTES  (96)
